...
class Config(object):
    ...
    APP_NAME = environ.get('APP_NAME', "Stribog Manager")
    
    ADMIN_USERNAME = environ.get('ADMIN_USERNAME', "admin")
    # SHA512
    # banana
    ADMIN_PASS_HASH = environ.get('ADMIN_PASS_HASH', "$6$rounds=656000$Q3Z3OlpOU0VOPRCd$LIRME01nvrON4QNQX1tTYAcBVRhujpG2GNdzCJHmvSJDMN4ZJDYkm5r4qb9WGXW9cPoDCxWnXL43tqU6IezTw0")
